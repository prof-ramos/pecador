...
Help me debug the issue: $DEBUG_DESCRIPTION
(e.g., "problem description", "relevant code snippet", "steps to reproduce", "expected vs actual behavior")
...
- `/debug "The export button doesn't trigger the download on iOS Safari"`
- `/debug "TypeError: Cannot read property 'map' of undefined in Checklist.tsx line 132"`
