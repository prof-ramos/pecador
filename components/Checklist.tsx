...
export default function Checklist({
  ...
  return (
    <div className="min-h-screen bg-parchment py-10 px-4 animate-page-reveal">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="flex items-center justify-center gap-4 mb-8">
            ...
            <svg className="w-8 h-8 text-[var(--celestial-gold)]" viewBox="0 0 24 24" fill="currentColor">
              <path d="M12 2l2.5 7.5H22l-6 4.5 2.5 7.5L12 17l-6.5 4.5L8 14 2 9.5h7.5z"/>
            </svg>
            <div className="w-24 h-px bg-gradient-to-r from-transparent via-[var(--celestial-gold)] to-transparent" />
          </div>

          <h1 className="text-4xl md:text-6xl font-display font-bold mb-4 text-[var(--celestial-text)]" style={{ fontVariationSettings: '"opsz" 144, "wght" 900' }}>
            Confessionário dos Pecados
          </h1>
          <p className="text-xl font-serif text-[var(--celestial-text-soft)] italic mb-6">
            Marque cada transgressão cometida neste ano de 2025
          </p>

          {/* Privacy Reminder */}
          <div className="inline-flex items-center gap-2 bg-[var(--celestial-ivory)] px-4 py-2 border border-[var(--celestial-gold)]/30 rounded-sm">
            <svg className="w-4 h-4 text-[var(--celestial-gold)]" viewBox="0 0 20 20" fill="currentColor">
        ...
        >
          <div className="bg-[var(--celestial-ivory)] border-2 border-[var(--celestial-gold)]/40 rounded-sm p-8 text-center shadow-lg relative overflow-hidden">
            {/* Decorative Corners */}
            <div className="absolute top-2 left-2 w-4 h-4 border-t-2 border-l-2 border-[var(--celestial-gold)]" />
            <div className="absolute top-2 right-2 w-4 h-4 border-t-2 border-r-2 border-[var(--celestial-gold)]" />
            <div className="absolute bottom-2 left-2 w-4 h-4 border-b-2 border-l-2 border-[var(--celestial-gold)]" />
            <div className="absolute bottom-2 right-2 w-4 h-4 border-b-2 border-r-2 border-[var(--celestial-gold)]" />

            <div className="text-7xl font-display font-bold text-[var(--celestial-gold)] mb-2" style={{ fontVariationSettings: '"opsz" 144, "wght" 900' }}>
              {selectedCount}
            </div>
        ...
        <div className="mb-10">
          <div className="flex flex-wrap justify-center gap-3">
            <button
              ...
              className={`px-5 py-2.5 font-gothic text-xs tracking-wider transition-all rounded-sm border-2 ${
                filter === 'all'
            ...
            {Object.values(CATEGORIES).map((cat) => {
              ...
              return (
                <button
                  ...
                  className={`px-4 py-2.5 font-gothic text-xs tracking-wider transition-all rounded-sm border-2 ${
                    isActive
              ...
              return (
                ...
                >
                  <button
                    ...
                    className={`w-full p-5 text-left transition-all duration-300 rounded-sm border-2 relative group ${
                      isSelected
                        ? 'bg-[var(--celestial-parchment)] border-[var(--celestial-gold)] shadow-lg transform scale-[1.02]'
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-shrink-0 mt-0.5">
                        <div
                          className={`w-7 h-7 rounded-none border-2 flex items-center justify-center transition-all ${
                            isSelected
                        ...
                        >
                          {isSelected && (
                            <svg className="w-5 h-5 text-[var(--celestial-text)]" viewBox="0 0 20 20" fill="currentColor">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className={`font-serif text-base leading-relaxed mb-3 ${isSelected ? 'text-[var(--celestial-text)]' : 'text-[var(--celestial-text-soft)]'}`}>
                          {sin.text}
                        </p>

                        <div className="flex items-center gap-3 flex-wrap">
                          <span className="inline-block px-3 py-1 bg-[var(--celestial-ivory)] border border-[var(--celestial-gold)]/30 rounded-sm">
        ...
        <motion.div
          ...
          className="sticky bottom-6 max-w-2xl mx-auto"
        >
          <div className="bg-[var(--celestial-ivory)]/95 backdrop-blur-sm border-2 border-[var(--celestial-gold)]/50 rounded-sm p-6 shadow-2xl">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="text-center md:text-left">
                <p className="font-gothic text-sm tracking-wider text-[var(--celestial-text)] mb-1">
                  Confissão Completa?
                </p>
                <p className="font-serif text-sm italic text-[var(--celestial-text-soft)]">
                  {canSubmit
              ...
              <button
                onClick={onSubmit}
                disabled={!canSubmit}
                className={`group relative px-10 py-4 font-gothic text-sm tracking-widest rounded-sm transition-all duration-300 shadow-lg ${
                  canSubmit
