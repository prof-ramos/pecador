        ...
        <div className="flex justify-between items-center mb-8 gap-4 flex-wrap">
          ...
          <div className="flex gap-3 items-center">
            ...
            <button
              ...
              className={`px-5 py-3 font-gothic text-xs tracking-wider rounded-sm border-2 transition-all ${
                isDiscreteMode
            ...
            >
              <span className="flex items-center gap-2">
                ...
                {isDiscreteMode ? 'Modo Discreto' : 'Modo Completo'}
              </span>
            </button>
    ...
    >
      ...
      <div className="relative z-10 p-12 flex flex-col justify-between h-full text-[var(${theme.textColor})]">
        ...
        <div className="space-y-12 my-16">
          {/* Giant Score */}
          <div className="text-center">
            <div className={`inline-block px-12 py-12 bg-[var(${theme.accentColor})]/10 border-2 border-[var(${theme.accentColor})]/40 rounded-sm ${isInfernal ? 'animate-pulse-heat' : ''}`}>
              <div className="text-[120px] leading-none font-display font-black mb-4" style={{ fontVariationSettings: '"opsz" 144, "wght" 900' }}>
                {result.score}
                <span className="text-6xl opacity-70">/100</span>
              </div>
              <div className={`w-32 h-1 bg-[var(${theme.accentColor})]/40 mx-auto mb-6`} />
              <p className="font-serif text-3xl italic leading-relaxed max-w-md mx-auto">
                {result.message}
              </p>
            </div>
          </div>
          ...
          {/* Dominant Category */}
          <div className="text-center">
            <p className="font-gothic text-sm tracking-widest uppercase opacity-70 mb-4">
              Categoria Dominante
            </p>
            <div className={`inline-block px-8 py-4 bg-[var(${theme.accentColor})]/10 border-2 border-[var(${theme.accentColor})]/40 rounded-sm`}>
              <p className="font-gothic text-2xl tracking-wider font-bold">
